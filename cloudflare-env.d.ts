/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 8dda4b27ea0abd9ce811fa836f8a330e)
...
interface __BaseEnv_CloudflareEnv {
	...
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* task-manager */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_EMAIL_ENABLED" | "NEXTJS_ENV">> {}
}
