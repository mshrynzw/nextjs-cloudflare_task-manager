...
KPI・今日のタスク・期限切れ・今後の予定は、閲覧できるプロジェクトのうち **自分が担当者のタスク** のみを対象とする。プロジェクト進捗と最近のアクティビティはチーム全体。未割り当てタスクは含めない。
...
- 通知設定
- テーマ設定
- 言語設定（日本語 / English。UI 既定は日本語）
- ワークスペース設定
- ワークスペースメンバーの追加・ロール変更・削除（Owner）
